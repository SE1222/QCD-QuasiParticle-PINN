...
This repository contains the implementation of a Physics-Informed Neural Network (PINN) designed to invert lattice QCD thermodynamics data into quasi-particle masses and a temperature-dependent Bag Constant $B(T)$.
...
## Files
- `PINN_2.py`: Main training script.
